...
public class Automail {
    ...
    public Automail(IMailDelivery delivery) {
    	...
    	/** Initialize robot */
    	robot1 = new WeakRobot(robotBehaviourW, delivery, mailPool, weak); /* shared behaviour because identical and stateless */
    	robot2 = new StrongRobot(robotBehaviourS, delivery, mailPool, strong);
    }
